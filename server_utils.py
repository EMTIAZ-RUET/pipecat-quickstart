"""
Server utilities for Twilio outbound calling with Pipecat.
Handles call initiation, TwiML generation, and WebSocket URL configuration.
"""
...
async def parse_twiml_request(request: Request) -> TwimlRequest:
    ...
    logger.info(f"TwiML request: To={to_number}, From={from_number}")
...
def get_websocket_url() -> str:
    ...
    Returns the local WebSocket URL for local development.
