"""
Twilio Outbound Call Server for Pipecat Voice Bot

Webhook server to handle outbound call requests, initiate calls via Twilio API,
and handle subsequent WebSocket connections for Media Streams with Bangla language support.
"""
...
async def root():
    ...
    return {"message": "Pipecat Twilio Voice Bot Server is running!", "language": "bn-BD"}
...
if __name__ == "__main__":
    ...
    logger.info("  POST /dialout   - Initiate outbound call")
    logger.info("  POST /twiml     - TwiML webhook for Twilio")
    logger.info("  WS   /ws        - WebSocket for Twilio Media Streams")
